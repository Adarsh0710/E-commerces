...
// //             <p className='w-8 md:w-11 h-[2px] bg-[#d17575]'></p>
// //             <p   className='libre-baskerville-bold font-medium text-sm md:text-base'>OUR BESTSELLERS</p>
// //           </div>
// //           <h1 prata-regular className='libre-baskerville-regular text-3xl sm:py- lg:text-5xl leading-relaxed'>
// //                  Quality is more       
// //           </h1>
// //           <h2 prata-regular className='libre-baskerville-regular text-3xl sm:py-3 lg:text-5xl leading-relaxed'>
// //                  important than quantity
// //           </h2>
// //           <div className='flex items-center gap-2'>

// //             <p  className='ibre-baskerville-regular-italic font-semibold text-sm md:text-base'>SHOP NOW</p>
// //             <p  cdclassName='w-8 md:w-11 h-[1px] bg-[#414141]'></p>
// //           </div>
// //         </div>
// //       </div>
// //       {/*hero rigth side */}
...
//             <p className='libre-baskerville-bold font-medium text-sm md:text-base bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%'>OUR BESTSELLERS</p>
//           </div>
//           <h1 className='libre-baskerville-regular text-3xl sm:py- lg:text-5xl leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-neutral-950'>
//             Quality is more
//           </h1>
//           <h2 className='libre-baskerville-regular text-3xl sm:py-3 lg:text-5xl leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-neutral-950'>
//             important than quantity
//           </h2>
//           <div className='flex items-center gap-2'>
