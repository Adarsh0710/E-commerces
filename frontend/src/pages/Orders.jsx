...
//                     <div key={index} className='py-4 border-t border-b text-gray-500 flex flex-col md:flex-row md:items-center md:justify-center gap-4'>
...
//           {}, // Empty body, as userId is derived from the token
...
//       const response = await axios.post(
//         `${backendUrl}/api/order/userorder`,  // Ensure this URL is correct
//         null,  // Send null or just omit the body
//         {
//           headers: {
...
//                 </div>
//                 <p className='mt-2'>
//                   Date: <span className='text-gray-700'>{item.date || 'N/A'}</span>
//                 </p>
//               </div>
//             </div>
//             <div className='md:w-1/2 flex justify-between'>
